...
.addStringOption(
  ...
  .addChoices(
      ...
      { name: 'Itsnotjustthis', value: 'Itsnotjustthis' },
...
module.exports.run = async (bot, Interaction, options) =>
{
    ...
    if(Interaction.channel.id != "1002606816473141288") return Interaction.reply({content: `You can only use this command in ${CongratsWinner}`})
