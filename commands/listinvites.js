...
module.exports.run = async (bot, Interaction, options) =>
{
    ...
    {
      queslist.setDescription(`__THIS CONTEST HAS ENDED__Below it shows the number of raffle tickets each user has for the invite contest, each ticket reflects 1 invites through the bot`)
      var checked = []
      var target
      var member_id
      for (var i = 0; i < globalvar.final_winner.length; i++)
