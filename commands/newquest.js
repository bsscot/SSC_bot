...
module.exports.run = async (bot, Interaction, options) =>
{
    ...
    var quest_ch = bot.channels.cache.find(channel => channel.id === `1004444708338155560`);
    if(Interaction.channel.id != "1004444708338155560") return Interaction.editReply({content: `You can only use this command in ${quest_ch}`})
