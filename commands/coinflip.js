...
{
    var CongratsWinner = bot.channels.cache.find(channel => channel.id === `1002582906742526073`);
    if(Interaction.channel.id != "1002582906742526073") return Interaction.editReply({content: `You can only play coinflip in ${CongratsWinner}`})
...
module.exports.button = async (bot, Interaction, user, action, another_user) => {
    ...
    const heads = "https://cdn.discordapp.com/attachments/938008439345545278/1002629728710168706/Heads.gif"
    const tails = "https://cdn.discordapp.com/attachments/938008439345545278/1002629729112817735/tails.gif"
